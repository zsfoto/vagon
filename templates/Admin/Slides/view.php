						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Slide') ?></h3>
...
<?php } ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Button Title') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($slide->button_title) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Button Link') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($slide->button_link) ?>
												...
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreBody" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($slide->body) ?>
