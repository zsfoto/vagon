						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Service') ?></h3>
...
<?php } ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Link') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($service->link) ?>
											...
											<div class="row"><!-- 3. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Delay') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($service->delay) ?><!-- 3.b -->
												</div>
											</div>
