            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
					<?php //= $this->Html->image('JeffAdmin./dist/img/avatar5.png', ['class'=>'profile-user-img img-fluid img-circle', 'style' => 'width: 128px; height: 128px;', 'alt'=>'User profile picture']) ?>
					<?= $this->Html->image(
