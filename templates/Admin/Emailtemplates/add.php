...
$this->assign('title', __('Add') . ' ' . __('Emailtemplate'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-plus fa-spin"></i> <?= __('Add') ?>: <?= __('Emailtemplate') ?></h3>
...
*/ ?>
											...
											<div class="mb-3 form-group row text required">
												...
												<div class="col-md-9">
													<?= $this->Form->control('slug', ['label' => __('Slug'), 'class' => 'form-control', 'empty' => false]); ?>
