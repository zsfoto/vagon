...
$this->assign('title', __('Edit') . ' ' . __('Service'));
?>
				<div id="form-row" class="services row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Service') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Services", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($service, ['id' => 'main-form']) ?>
...
*/ ?>
											...
											<!-- 2. STRING: body: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="body"><?= __('Body') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('body', ['label' => __('Body'), 'class' => 'form-control', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: link: string  -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="link"><?= __('Link') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('link', ['label' => __('Link'), 'class' => 'form-control', 'empty' => true]); ?>
											...
											<div class="mb-3 form-group row number required">
												...
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<?= $this->Form->control('delay', ['class' => 'form-control', 'data-decimals' => '0', 'min' => '0', 'max' => '999999999999', 'step' => '1', 'empty' => false]); ?>
