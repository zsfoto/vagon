						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Emailtemplate') ?></h3>
												...
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreBody" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($emailtemplate->body) ?>
