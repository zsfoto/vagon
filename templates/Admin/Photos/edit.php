						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									...
									<span class="fw-bold text-danger"><?= __('Image size must be 800x600px!!!') ?></span>
								</div>
...
*/ ?>
							...
							<?= $this->Form->create($photo, ['id' => 'main-form', 'enctype' => 'multipart/form-data']) ?>
...
*/ ?>
											...
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="name"><?= __('File') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('file', ['type' => 'file', 'label' => __('File name'), 'class' => 'form-control', 'empty' => false, 'autofocus' => true]); ?>
											...
											<div class="mb-3 form-group row number required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="body"><?= __('Body') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9 col-xxl-9">
													<?= $this->Form->control('body', ['id' => 'body', 'label' => false, 'class' => '', 'empty' => false, 'style' => 'width: 100%;']); ?>
												</div>
											</div>

											<!-- 9. MULTISELECT: photocategories -->
											<div class="mb-3 form-group row select">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="photocategories"><?= __('Photocategories') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('photocategories._ids', ['class' => 'form-control', 'options' => $photocategories, 'data-live-search' => false, 'data-actions-box' => false, 'data-container' => 'body', 'data-size' => '6']); ?>
												</div>
											</div>
