...
*/ ?>
					...
					<div class="input-group mb-3">
						<?= $this->Form->control('role', ['options' => $roles, 'class' => 'selectpicker form-control integer', 'title' => 'Kérem válasszon...', 'data-live-search' => 'true', 'data-actions-box' => 'true', 'label' => false]); ?>
						<div class="input-group-append">
							<div class="input-group-text">
						...
						<div class="icheck-primary">
							<?php
								echo $this->Form->control('is_superuser', [
									'type' => 'checkbox', 
									'label' => ' ' . __d('cake_d_c/users', 'Super User'), 
									'required' => false
								]);
							?>
						</div>
