						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Partner') ?></h3>
...
<?php } ?>
											...
											<div class="row"><!-- 3. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($partner->delay) ?><!-- 3.b -->
												</div>
											</div>
											<div class="row"><!-- 5. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Show In Main Page') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $partner->show_in_main_page ? '<i class="fa fa-check-square boolean-yes" aria-hidden="true"></i>' : '<i class="fa fa-square boolean-no" aria-hidden="false"></i>' ?>

												</div>
											</div>
<?php /*
											<div class="row"><!-- 6. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Details') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Text->autoParagraph(h($partner->details)) ?>
...
*/ ?>
										...
										<!-- TAB for: Details text field -->
										<div class="tab-pane fade" id="tabPanelDetails" role="tabpanel" aria-labelledby="tabDetails" tabindex="0">
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreDetails" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($partner->details) ?>
