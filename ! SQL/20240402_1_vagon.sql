...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Ápr 02. 15:39
...
CREATE TABLE `abouts` (
  ...
  `main_body` varchar(1000) DEFAULT NULL,
  ...
  `our_services_body` varchar(1000) DEFAULT NULL,
  `our_customers_title` varchar(100) DEFAULT NULL,
  `our_customers_body` varchar(1000) DEFAULT NULL,
...
(1, 'hu', 'Üdvözöljük a vagontakarítás oldalán', 'Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.', 'Nézze meg galériánkat', '/photos', 1, 100, '2024-03-25 11:32:04', '2024-03-25 11:32:04'),
(2, 'hu', 'Válalljuk a régi vagonok ...', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'Nézze meg galériánkat', '/photos', 1, 200, '2024-03-25 11:33:32', '2024-03-25 11:33:32'),
...
(4, 'hu', 'cookies', 'Cookie tájékoztató', '<h2>Cookie tájékoztató</h2><p>Szöveg helye<br></p>', 1, 500, '2024-04-02 12:58:46', '2024-04-02 12:58:46');
...
('dd42956c-7f11-4146-9b0a-50e948aeded9', 'superadmin', 'zsolt@saghysat.hu', '$2y$10$emtW6ajq7Ta9/Moo/J2QVeEqsuBuUodgkq4M2vk5jLK/cs099WUua', 'Zsolt', 'Varga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 'admin', '2024-03-28 12:02:26', '2024-03-28 13:45:03', NULL, '2024-04-02 12:50:42');
