...
$this->assign('title', __('Edit') . ' ' . __('Client'));
?>
				<div id="form-row" class="clients row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Client') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($client, ['id' => 'main-form']) ?>
...
*/ ?>
											...
											<div class="mb-3 form-group row text required">
												...
												<div class="col-md-9">
													<?= $this->Form->control('filename', ['label' => __('Filename'), 'class' => 'form-control', 'empty' => false]); ?>
											...
											<!-- 7. BOOLEAN: show_in_mainpage: boolean  required -->
											<div class="mb-3 form-group row checkbox">
												<div class="col-sm-2 col-form-label required"></div>
												<div class="col-sm-10">
													<?= $this->Form->control('show_in_mainpage', ['empty' => false]); ?>
