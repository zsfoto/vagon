...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('token_expires'<?= $user->token_expires !== null ? ", '" . $user->token_expires->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('activation_date'<?= $user->activation_date !== null ? ", '" . $user->activation_date->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('tos_date'<?= $user->tos_date !== null ? ", '" . $user->tos_date->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('last_login'<?= $user->last_login !== null ? ", '" . $user->last_login->format('Y-m-d H:i:s') . "'" : "" ?>)
